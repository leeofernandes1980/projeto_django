...
SECRET_KEY = 'django-insecure-o#yp9^ule2)#788=2j9sjf8&_dlxw&*1p_!rsru1_bt=hs&##x'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Diretório global opcional para templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Pasta de arquivos estáticos para desenvolvimento
